...
public class Door extends GameEntity
{
    ...
    public Door(float x, float y, float width, float height, float weightReq) {
        _position.x = x;
        _position.y = y;
        this.width = width;
        this.height = height;
